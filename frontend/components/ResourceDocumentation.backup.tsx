    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold text-white capitalize">{resourceName}</h1>
      ...
      {/* Two-Column Layout: Request Builder + Response */}
      <div className="grid lg:grid-cols-5 gap-6">
        {/* LEFT: Request Builder (Sticky) */}
        <div className="lg:col-span-2">
          <div className="lg:sticky lg:top-4 space-y-4">
            <div className="bg-slate-800/50 backdrop-blur p-5 rounded-lg border border-slate-700">
